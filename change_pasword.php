...
$prof_qry = pg_query($db,"SELECT * FROM user_register  WHERE register_id = '$user_id'");
...
if(isset($_POST['changebtn'])){
    ...
    #geting  old password 
    $pass_qry = pg_query($db,"SELECT password FROM user_login  WHERE user_id = '$user_id'");
    $pass_data = pg_fetch_array($pass_qry);
    if($pass_data['password'] != $password){
        echo "Your entered old password is incorrect";
    }elseif($npassword != $cpassword){
        echo "New password missmatch";
    }else{
    #query for change password PostgreSQL 
    $res = pg_query($db,"UPDATE user_login SET password='$cpassword' WHERE user_id = '$user_id' ");
    #get last insert id
    if ($res) {
...
<html lang="en">
  ...
  <body>
    ...
    <li class="list-group-item"> <i class="fa fa-user-o" style="font-size:40px">&nbsp;</i><a href="dasboard.php" style="text-decoration: none;color:black"><?php echo $prof_data['firstname'];  ?></a></label></li>
        <li class="list-group-item"><i class="fa fa-pencil-square-o" style="font-size:40px">&nbsp;</i><a href="edit_profile.php" style="text-decoration: none;color:black">Edit Profile</a></li>
        <li class="list-group-item"><i class="fa fa-key" style="font-size:40px">&nbsp;</i><a href="change_pasword.php" style="text-decoration: none;color:black">Change Password</a></li>
    ...
    <div class="row">
        ...
        <form class="row g-3" method='post' enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="oldpass" class="form-control input" id="oldpass" placeholder="Enter old password">
                    </div>
                    <div class="col-md-12">

                        <input type="text" name="npass" class="form-control input" id="surname" placeholder="Enter new password">
                    </div>
                    <div class="col-12">

                        <input type="text" name="cpass" class="form-control input" id="mobemail" placeholder="Confirm  new password">
                    </div> 
                    <div class="col-12">
                    <button type="clear"  class="button">Cancel</button> <button type="submit" name='changebtn' class="button">Change</button>
